...
class detailsRecomPage extends StatefulWidget {
  const detailsRecomPage({Key? key}) : super(key: key);

  @override
  State<detailsRecomPage> createState() => _detailsRecomPageState();
}

class _detailsRecomPageState extends State<detailsRecomPage> {
  @override
