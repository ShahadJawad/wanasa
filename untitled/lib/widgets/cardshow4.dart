...
class cardShow4 extends StatefulWidget {
  const cardShow4({super.key});
  @override
  State<cardShow4> createState() => _cardShowState();
}

class _cardShowState extends State<cardShow4> with SingleTickerProviderStateMixin {
  //logic//
  ...
  getData() async {
    FirebaseFirestore.instance.collection('places').where("category" , isEqualTo:5).get().then((value) {
      setState(() {
        data = value.docs;
      });
    });
