...
class cardShow3 extends StatefulWidget {
  const cardShow3({super.key});
  @override
  State<cardShow3> createState() => _cardShowState();
}

class _cardShowState extends State<cardShow3> with SingleTickerProviderStateMixin {
  //logic//
  ...
  getData() async {
    FirebaseFirestore.instance.collection('places').where("category" , isEqualTo:4).get().then((value) {
      setState(() {
        data = value.docs;
      });
    });
