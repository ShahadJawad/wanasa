...
class cardShow5 extends StatefulWidget {
  const cardShow5({super.key});
  @override
  State<cardShow5> createState() => _cardShowState();
}

class _cardShowState extends State<cardShow5> with SingleTickerProviderStateMixin {
  //logic//
  ...
  getData() async {
    FirebaseFirestore.instance.collection('places').where("category" , isEqualTo:6).get().then((value) {
      setState(() {
        data = value.docs;
      });
    });
