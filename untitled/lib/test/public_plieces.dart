...
// }
//
// class _MyCustomUIState extends State<PublicPage> with TickerProviderStateMixin {
...
//                       return  card("${snapshot.data![i]['placeName']}", 'Example',imagelist[i].myimage ,
//                           RouteWhereYouGo());
//
//
//                     },);
...
//           //
//           //       return card("${snapshot.data![index]['placeName']}", 'Example',imagelist[index].myimage ,
//           //           RouteWhereYouGo());
//           //
//           //
//           //       }
